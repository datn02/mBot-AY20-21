...
float gain_left = 135.5f;
float gain_right = 155.5f;
...
uint8_t turn_speed = 100;
uint8_t move_speed = 200;
...
//  else if (ultraSensor.distanceCm() - distance < stop_value || stop_flag) {
//    Left_Motor.stop();
//    Right_Motor.stop();
//    stop_flag = true;
// //   delay(500);
